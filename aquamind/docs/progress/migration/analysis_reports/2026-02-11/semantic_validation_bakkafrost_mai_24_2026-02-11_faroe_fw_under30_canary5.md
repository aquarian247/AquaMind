...
- Batch: `Bakkafrost mai 24` (id=444)
- Populations: 164
...
- Assignment zero-count rows (population_count <= 0): 46 total, 43 bridge-classified, 3 same-stage superseded-zero, 0 short-lived orphan-zero, 0 no-count-evidence-zero, 0 known-loss-depleted-zero, 0 non-bridge.
