...
- Batch: `Stofnfiskur Juni 24` (id=391)
- Populations: 145
...
- Assignment zero-count rows (population_count <= 0): 30 total, 26 bridge-classified, 2 same-stage superseded-zero, 2 short-lived orphan-zero, 0 no-count-evidence-zero, 0 known-loss-depleted-zero, 0 non-bridge.
...
| Fry -> Parr | 502720 | 788597 | 285877 | 3 | 3 | yes | Entry window (incomplete linkage) | WARN: positive delta under incomplete linkage fallback |
