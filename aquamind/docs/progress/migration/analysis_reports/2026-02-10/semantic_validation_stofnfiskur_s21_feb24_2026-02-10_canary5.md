...
- Batch: `Stofnfiskur S-21 feb24` (id=380)
- Populations: 253
...
- Assignment zero-count rows (population_count <= 0): 67 total, 66 bridge-classified, 1 same-stage superseded-zero, 0 short-lived orphan-zero, 0 non-bridge.
