...
- Assignment zero-count rows (population_count <= 0): 95 total, 23 bridge-classified, 42 same-stage superseded-zero, 0 short-lived orphan-zero, 30 no-count-evidence-zero, 0 known-loss-depleted-zero, 0 non-bridge.
- Transfer actions with transferred_count <= 0: 0 of 278.
