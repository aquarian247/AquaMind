...
- Assignment zero-count rows (population_count <= 0): 165 total, 165 bridge-classified, 0 same-stage superseded-zero, 0 short-lived orphan-zero, 0 no-count-evidence-zero, 0 known-loss-depleted-zero, 0 non-bridge.
- Transfer actions with transferred_count <= 0: 0 of 262.
- Fishgroup classification: 152 temporary bridge fishgroups, 28 real stage-entry fishgroups, 268 temporary bridge populations.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| Egg&Alevin -> Fry | 1507478 | 1341103 | -166375 | 6 | 6 | yes | Bridge-aware (linked sources: 7); lineage graph fallback used | OK |
| Fry -> Parr | 1341103 | 891722 | -449381 | 6 | 6 | yes | Bridge-aware (linked sources: 6); lineage graph fallback used | OK |
| Parr -> Smolt | 74289 | 35245 | -39044 | 1 | 1 | yes | Bridge-aware (linked sources: 2); lineage graph fallback used | OK |
| Smolt -> Post-Smolt | 166842 | 55769 | -111073 | 8 | 8 | yes | Bridge-aware (linked sources: 5); lineage graph fallback used | OK |
