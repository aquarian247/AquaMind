...
- Assignment zero-count rows (population_count <= 0): 240 total, 36 bridge-classified, 177 same-stage superseded-zero, 0 short-lived orphan-zero, 27 no-count-evidence-zero, 0 known-loss-depleted-zero, 0 non-bridge.
- Transfer actions with transferred_count <= 0: 0 of 282.
- Fishgroup classification: 100 temporary bridge fishgroups, 62 real stage-entry fishgroups, 100 temporary bridge populations.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| Egg&Alevin -> Fry | 0 | 3308215 | 3308215 | 12 | 12 | yes | Bridge-aware (direct edge linkage; linked sources: 12) | ALERT: population increases without mixed-batch composition |
| Fry -> Parr | 3308215 | 2196888 | -1111327 | 7 | 7 | yes | Bridge-aware (linked sources: 50) | OK |
| Parr -> Smolt | 0 | 127243 | 127243 | 2 | 2 | yes | Bridge-aware (direct edge linkage; linked sources: 2) | ALERT: population increases without mixed-batch composition |
| Smolt -> Post-Smolt | 0 | 280469 | 280469 | 2 | 2 | yes | Bridge-aware (direct edge linkage; linked sources: 2) | ALERT: population increases without mixed-batch composition |
...
| Gate | Result | Details |
| --- | --- | --- |
| `no_positive_transition_delta_without_mixed_batch` | FAIL | Positive stage transition deltas without mixed-batch composition rows: 3 (excluded incomplete-linkage fallback rows: 0) |
