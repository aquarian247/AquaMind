...
router.register(r'area-groups', AreaGroupViewSet, basename='area-groups')
...
router.register(r'transport-carriers', TransportCarrierViewSet, basename='transport-carrier')
...
router.register(r'history/area-groups', AreaGroupHistoryViewSet, basename='area-groups-history')
...
router.register(r'history/transport-carriers', TransportCarrierHistoryViewSet, basename='transport-carrier-history')
