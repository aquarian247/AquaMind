...
from apps.infrastructure.api.viewsets.area_group import AreaGroupViewSet
...
from apps.infrastructure.api.viewsets.transport_carrier import TransportCarrierViewSet
