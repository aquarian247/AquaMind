...
from apps.inventory.api.serializers.base import FeedRelatedSerializer, TimestampedModelSerializer
from apps.inventory.api.serializers.validation import validate_date_range


class FeedPurchaseSerializer(FeedRelatedSerializer, TimestampedModelSerializer):
    """
    ...
    def validate(self, data):
        ...
        if 'purchase_date' in data and 'expiry_date' in data and data['expiry_date']:
