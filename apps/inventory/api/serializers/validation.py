...
This module contains reusable validation functions for serializers in the inventory app.
"""
...
def validate_batch_assignment_relationship(batch, batch_assignment):
    ...
    Raises:
        serializers.ValidationError: If the batch assignment doesn't belong to the batch
    """
...
def validate_batch_and_date_range(batch_id, start_date, end_date):
    ...
    Raises:
        serializers.ValidationError: If the batch doesn't exist or date range is invalid
    """
