...
class ReadWriteFieldsMixin:
    ...
    by IDs for write operations but by string representations for read
    operations.
    """
    def get_fields(self):
        """
        ...
        for field_name, field in list(fields.items()):
            ...
            # If there's already a field with the base name, make the _id field
            # write-only
...
class NestedModelMixin:
    ...
    def create_or_update_related(
        self, related_data, serializer_class, instance=None
    ):
        """
