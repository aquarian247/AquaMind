...
from .utils import StandardErrorMixin, ReadWriteFieldsMixin, NestedModelMixin
...
class UpdatedModelSerializer(InventoryBaseSerializer):
    ...
    Use this for models representing continuous state where creation time is not meaningful.
    """
    class Meta:
        fields = ['updated_at']
...
class FeedingBaseSerializer(FeedRelatedSerializer, BatchRelatedSerializer, ContainerRelatedSerializer):
    """
