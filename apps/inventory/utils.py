...
This module contains reusable components for models and serializers in the inventory app.
"""
...
class DecimalFieldMixin:
    ...
    @staticmethod
    def positive_decimal_field(max_digits=10, decimal_places=2, min_value=0, **kwargs):
